...
export default function ExperienceCard({
  ...
  return (
    <div className={`group overflow-hidden rounded-2xl border transition-all duration-300 ${
      ...
      {/* ⚡ Bolt: Removed isClient wrapper and useEffect to eliminate unnecessary double-renders. Standard HTML elements do not suffer from SSR hydration mismatches. */}
      {video && (
