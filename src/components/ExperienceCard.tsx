  ...
  return (
    <div className={`group overflow-hidden rounded-2xl border transition-all duration-300 ${
      ...
      {/*
        ...
        Removed isClient state wrapper and useEffect for the video element.
        Standard HTML elements do not suffer from hydration mismatches.
        This prevents an unnecessary double-render on mount and improves TTI/LCP.
      */}
      {video && (
