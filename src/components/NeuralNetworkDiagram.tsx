...
export default function NeuralNetworkDiagram({
  ...
  const { layers, connections } = useMemo(() => {
    ...
    const generatedConnections: { x1: number; y1: number; x2: number; y2: number; key: string; length: number; index: number }[] = [];
    let connIndex = 0;
