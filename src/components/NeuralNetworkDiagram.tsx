...
export default function NeuralNetworkDiagram({
  ...
  // Optimization: useMemo caches the layer calculations, avoiding redundant computations on every re-render.
  // We also move the default nodeCount array outside the component to prevent recreating a new array on every render.
  ...
  // Optimization: Pre-calculate the SVG line lengths computationally inside useMemo rather than
  // relying on an imperative useEffect that queries the DOM via querySelectorAll, which causes layout thrashing.
