...
export default function NeuralNetworkDiagram({
  ...
  // Pre-calculating node and connection layout mathematically during the render phase
  // inside useMemo completely eliminates the need for expensive DOM querying
  // (querySelectorAll) and layout thrashing (getAttribute) in a useEffect.
  // This allows the component to support static rendering/SSR properly.
