  ...
  return (
    <div className={`relative ${className}`}>
      {/*
        ...
        Removed imperative useEffect that parsed DOM elements for length calculations.
        Precalculating lengths in useMemo prevents layout thrashing and avoids SSR hydration mismatches.
        Default array prop extracted to prevent referential equality issues.
      */}
      <svg
