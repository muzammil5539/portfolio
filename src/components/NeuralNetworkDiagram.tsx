...
export default function NeuralNetworkDiagram({
  ...
  // ⚡ Bolt: Use useMemo to mathematically calculate positions instead of querying the DOM in a useEffect
  // This avoids layout thrashing, prevents double-renders, and improves Time-to-Interactive
  ...
  }, [nodeCount]); // width and height are constant, no need to include

  // ⚡ Bolt: Mathematically precalculate line lengths in useMemo and declaratively pass them
  // as inline CSS styles, bypassing the need for `.querySelectorAll` and `.getAttribute('x2')`
