...
export default function NeuralNetworkDiagram({
  ...
  const { layers, connections, layerSpacing } = useMemo(() => {
    ...
    return { layers: calculatedLayers, connections: calculatedConnections, layerSpacing: layerSpc };
  }, [nodeCount]);
