...
export default function NeuralNetworkDiagram({
  ...
  const connections = useMemo(() => {
    const conns: { x1: number; y1: number; x2: number; y2: number; key: string; length: number; delay: string }[] = [];
    let connIndex = 0;
            ...
            style={
              {
                ...
                animation: animated ? `lineFlow 3s ${conn.delay} ease-in-out infinite` : undefined,
